...
import SolidierCookie from '../assets/cookie/SolidierCookie.svg';
...
const Home2 = ({ userObj }) => {
  ...
  const cookies = new Array(WhoGinger, BellBoyCookie, SleepyheadCookie, BabyCookie, PirateCookie, GreatCookie, MilkHotSpringCookie,
    DetectiveCookie, ClassicCookie, KingCookie, HappyCookie, ScaredCookie, CollegeCookie, DraculaCookie, SolidierCookie);
